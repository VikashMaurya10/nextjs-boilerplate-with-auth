...
const carouselVariants = cva('', {
  variants: {
    variant: {
      default: 'flex h-full w-full items-center justify-between gap-2',
      secondary: 'relative',
    },
  },
  defaultVariants: {
...
const navigationButtonVariants = cva(
  'inline-flex items-center justify-center rounded-md whitespace-nowrap transition-colors focus-visible:ring-1 focus-visible:ring-stone-950 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
...
const Swiper = forwardRef(
  (
    ...
    const renderNavigationButton = useCallback(
      ...
      [buttonOptions, variant, handlePrevSlide, handleNextSlide]
    );
