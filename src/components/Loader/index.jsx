...
export const Loader = () => {
  return (
    <section className="pointer-events-none fixed inset-0 z-50 grid min-h-screen w-full place-items-center bg-white backdrop-blur-sm dark:bg-black dark:text-white">
