...
export const rangeText = (view, date) => {
...
export const getEventsCount = (events, date, view) => {
  const compareFns = {
    agenda: isSameMonth,
    year: isSameYear,
    day: isSameDay,
...
export const groupEvents = (dayEvents) => {
...
export const getEventBlockStyle = (event, day, groupIndex, groupSize, visibleHoursRange) => {
...
export const getCalendarCells = (selectedDate) => {
...
export const calculateMonthEventPositions = (multiDayEvents, singleDayEvents, selectedDate) => {
...
export const getMonthCellEvents = (date, events, eventPositions) => {
