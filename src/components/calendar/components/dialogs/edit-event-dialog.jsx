...
export const EditEventDialog = ({ children, event }) => {
    ...
    <Dialog open={isOpen} onOpenChange={onToggle}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            This is just and example of how to use the form. In a real application, you would call
            the API to update the event
          </DialogDescription>
        </DialogHeader>
